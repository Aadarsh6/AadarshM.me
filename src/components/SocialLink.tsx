...
// Map your database/social strings to the corresponding icons
...
function SocialLink({ social }: SocialLinkProps) {
  // Defaults to Mail if the icon string from your data doesn't match the map
